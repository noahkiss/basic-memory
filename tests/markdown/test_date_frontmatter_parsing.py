...
This test reproduces a defect where date fields
...
async def test_parse_file_with_list_frontmatter_fields(tmp_path):
    ...
    Reproduces the defect where a markdown file has YAML list values
...
async def test_parse_file_with_reserved_frontmatter_field_content(tmp_path):
    ...
    Reproduces the defect where frontmatter containing a field named
